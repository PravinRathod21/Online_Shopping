                        ...
                        ?>
                            <div class='content'>
                                <div class='img-box'style='    margin-top: 8%;'>
                                    <a href="http://localhost:8080/coreigniter_4/Crud/view_info?id=<?php echo $row->id; ?>"><img style='width: 150px;height: 150px;'class='images' src="<?php echo $row->image; ?>"></img></a>
                                </div>
